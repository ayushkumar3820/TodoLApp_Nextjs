...
"[project]/app/api/todos/route.js [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
(()=>{
    const e = new Error("Cannot find module '../../todos'");
...
async function POST(request) {
    ...
    //   completed: false,
    // };
    const { id, text, completed } = await __TURBOPACK__imported__module__$5b$project$5d2f$model$2f$todoModel$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        text: todo.text
    });
    todos.push(newTodo);
    await (0, __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["writeFile"])("todos.json", JSON.stringify(todos, null, 2));
    // return Response.json(newTodo, {
    //   status: 201,
    // });
    return Response.json(id, text, completed, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1d3b2e26._.js.map